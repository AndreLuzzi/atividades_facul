...
insert into produtos (nome, quantidade, preco, id_categoria) values
  ('Lampshade', 100, 800, 4),
...
(1, 'João Silva', 'Cascavel'),
(2, 'Maria Oliveira', 'Toledo'),
(3, 'Carlos Souza', 'Foz do Iguaçu'),
(4, 'Ana Pereira', 'Cascavel');
...
select p.id_pedido, c.nome as nome_cliente, c.cidade
from pedidos p
...
full outer join produtos pr on ip.id_produto = pr.id_produto;
